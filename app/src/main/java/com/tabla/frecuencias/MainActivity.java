...
import android.widget.Toast;import android.app.AlertDialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText txtnumMayor = findViewById(R.id.txtnumMayor); //findViewById busca una bista de igual id en el xml
        ...
        btncalcular.setOnClickListener(view -> {
            ...
            // Obtener el texto del EditText y luego convertirlo a entero
            int Num1 = Integer.parseInt(txtnumMayor.getText().toString());

            // Convertir directamente el texto del EditText a entero
            int Num2 = Integer.parseInt(txtnumMenor.getText().toString());
            ...
            //double Micha = Math.round(valorInter/2);
            //final double[] Mediana = {0};
